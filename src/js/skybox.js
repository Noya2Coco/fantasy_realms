...
export class Skydome {
    constructor(scene) {
        ...
        const skydome = MeshBuilder.CreateSphere("skyDome", { segments: 64, diameter: 10000 }, this.scene); // Plus de segments = moins d’artefacts
        ...
        skydomeMaterial.diffuseTexture = new Texture("/img/skybox/space.jpg", this.scene);
